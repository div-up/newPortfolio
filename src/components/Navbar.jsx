...
export default function Navbar({ theme, onToggleTheme }) {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 right-0 z-50 flex flex-col items-end gap-3 p-6 md:p-8"
    >
      <div className="flex flex-col items-end gap-2">
        ...
        <button type="button" onClick={onToggleTheme}
          style={{ fontFamily: 'Space Grotesk,sans-serif', fontSize: 'clamp(9px,0.85vw,11px)', letterSpacing: '0.2em', color: 'var(--link)', background: 'transparent', border: '1px solid var(--section-border)', borderRadius: '9999px', cursor: 'pointer', padding: '6px 10px', transition: 'color 0.3s, border-color 0.3s' }}
          onMouseEnter={e => e.currentTarget.style.color = '#c0522a'}
